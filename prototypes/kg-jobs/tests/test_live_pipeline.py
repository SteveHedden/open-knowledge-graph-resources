...
def test_default_himalayas_pipeline_runs_four_query_families_and_deduplicates(tmp_path):
    ...
    assert run["queryResults"] == [
        ...
        for source_uri, query, concepts in (
            (
                "https://openknowledgegraphs.com/prototypes/kg-jobs/source/himalayas-query-knowledge-graph",
                "knowledge graph",
                ["https://openknowledgegraphs.com/prototypes/kg-jobs/vocab/skill-knowledge-graph"],
            ),
            (
                "https://openknowledgegraphs.com/prototypes/kg-jobs/source/himalayas-query-ontology",
                "ontology",
                [
                    "https://openknowledgegraphs.com/prototypes/kg-jobs/vocab/role-ontologist",
                    "https://openknowledgegraphs.com/prototypes/kg-jobs/vocab/role-ontology-engineer",
                ],
            ),
            (
                "https://openknowledgegraphs.com/prototypes/kg-jobs/source/himalayas-query-semantic-web",
                "semantic web",
                ["https://openknowledgegraphs.com/prototypes/kg-jobs/vocab/skill-semantic-web"],
            ),
            (
                "https://openknowledgegraphs.com/prototypes/kg-jobs/source/himalayas-query-sparql",
                "SPARQL",
                ["https://openknowledgegraphs.com/prototypes/kg-jobs/vocab/skill-sparql"],
            ),
        )
    ]
